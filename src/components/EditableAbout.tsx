        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-16">
          ...
          <div className="space-y-6">
            <div className="relative">
              <div className="text-6xl lg:text-8xl text-orange-200 font-serif absolute -top-4 -left-4 leading-none">"</div>
              <div className="relative z-10 pl-6 lg:pl-8">
                <p className="text-gray-700 text-base lg:text-lg leading-relaxed font-light">
                  {content.description}
                </p>
              </div>
            </div>
          ...
          {/* About Us Card */}
          <div className="relative">
            <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden shadow-xl">
              <div className="relative z-10 space-y-4 lg:space-y-6">
                <div className="flex items-center space-x-4">
                  <h3 className="text-white font-bold text-lg lg:text-xl">{content.aboutUsCard.title}</h3>
                ...
                <p className="text-white/95 leading-relaxed text-sm lg:text-base font-light">
                  {content.aboutUsCard.content}
                </p>
              </div>
              
              {/* Background Pattern */}
              <div className="absolute top-0 right-0 w-32 h-32 lg:w-40 lg:h-40 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
              <div className="absolute bottom-0 left-0 w-24 h-24 lg:w-32 lg:h-32 bg-white/5 rounded-full translate-y-12 -translate-x-12"></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 lg:p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="text-center group">
              <div className="text-4xl lg:text-5xl xl:text-6xl font-bold text-orange-600 mb-2 transition-all duration-300 group-hover:scale-110">
                {content.statistics.projects.number}
              </div>
              <div className="text-gray-600 font-semibold text-base lg:text-lg uppercase tracking-wide">
