...
const EditableAbout: React.FC<EditableAboutProps> = ({ section, onSectionUpdate }) => {
  ...
  return (
    <section 
      id={section.id}
      className={`${style?.padding || 'py-16 lg:py-24'} ${style?.backgroundColor || 'bg-gray-50'}`}
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16 lg:mb-20">
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="relative mb-8">
              <div className="text-7xl lg:text-8xl text-orange-200 font-serif absolute -top-4 -left-4 leading-none">"</div>
              <div className="relative z-10 pl-8 lg:pl-10">
          ...
          <div className="flex items-start">
            <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-3xl p-8 lg:p-10 text-white relative overflow-hidden shadow-2xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 lg:p-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
            <div className="text-center group">
              <div className="text-4xl lg:text-5xl xl:text-6xl font-bold text-orange-600 mb-3 transition-all duration-300 group-hover:scale-110">
